    ...
    <hr>
            ...
            <div class="col-md-5 no-padding lib-item" data-category="view">
                <div class="lib-panel">
                    <div class="row box-shadow">
                        <div class="col-md-6">
                            <img class="lib-img-show" src="images/g8.jpg">
                        </div>
                        <div class="col-md-6">
            ...
            <div class="col-md-5 no-padding lib-item" data-category="ui">
                <div class="lib-panel">
                    <div class="row box-shadow">
                        <div class="col-md-6">
                            <img class="lib-img" src="images/g9.jpg">
                        </div>
                        <div class="col-md-6">
                            <div class="lib-row lib-header">
                                gym2
...
gym4                                <div class="lib-header-seperator"></div>
                            ...
                            <div class="lib-row lib-desc">
                                Lorem ipsum dolor Lorem ipsum dolor Lorem ipsum dolor Lorem ipsum dolor Lorem ipsum dolor Lorem ipsum dolor Lorem ipsum dolor Lorem ipsum dolor Lorem ipsum dolor Lorem ipsum dolor Lorem ipsum dolor Lorem ipsum dolor yuguyf
                            </div>
                            <div class="wrap">
                             <form action="book.php" method="post">
